  ...
  return (
    ...
    >
      <div className="w-[555px] h-[294px] flex flex-col items-start justify-start gap-[30px] md:h-auto md:flex-col md:items-center md:justify-center">
        ...
        <button className="cursor-pointer [border:none] py-[18px] px-0 bg-blueviolet w-[150px] shadow-[0px_0px_25px_rgba(140,_48,_245,_0.25)] rounded-2xl overflow-hidden flex flex-row items-center justify-center box-border">
