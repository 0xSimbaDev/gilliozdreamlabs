...
const ProblemSection: NextPage<ProblemSectionType> = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch h-[895px] flex flex-row items-center justify-center py-0 px-[150px] box-border gap-[30px] bg-[url('/problem-section@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-17xl text-white font-montserrat md:flex-col gap-[30px] md:pl-[30px] md:pr-[30px] md:box-border ${className}`}
    >
