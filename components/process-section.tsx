...
const ProcessSection: NextPage<ProcessSectionType> = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch h-[895px] flex flex-col items-center justify-center py-0 px-[150px] box-border gap-[70px] bg-[url('/process-section@3x.png')] bg-cover bg-no-repeat bg-[top] text-center text-17xl text-white font-montserrat ${className}`}
    >
